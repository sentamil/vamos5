...
<div id="header" style="height: 75px;">
    ...
    border-collapse: separate; width: 75%;" >
     ...
     <td style="padding-left:5px;background-color:#2d9b5e; "> <a href="" id="ref1"><input  type="button" id="setsearch1" value="Submit" style="color:white;background-color:#2d9b5e; border: 0px;"/></a></td>
      ...
      <table style="border: 2px solid #2d9b5e; margin-top: 6px;; size:25px; margin-left: 81px; border-radius: 5px; border-spacing: 3px;
    border-collapse: separate; width: 75%;" >
     <tr>
     ...
     <table style="border: 2px solid #2d9b5e; margin-top: 23px; size:25px; margin-left: 25px; border-radius: 5px; border-spacing: 3px;
...
<aside id="menu">
    ...
    <!--  <li>
        ...
        @endif 
            ...
            <li><a href="../vdmGroups/create"> <span class="nav-label">Create Group</span></a></li>
            ...
            <li> <a href="../vdmUsers/create"> <span class="nav-label">User Create</span></a></li>
         ...
         <a href="Routes"> <span class="nav-label">Dealers</span><span class="fa arrow"></span></a>
            ...
            <li>
            <a href="Routes"> <span class="nav-label">Organisations</span><span class="fa arrow"></span></a>

										...
										<table id="example1" class="table table-bordered dataTable">
											...
											<tbody>
												...
												<tr>
													...
													{{ Form::close() }} <a class="btn btn-small btn-success" href="{{ URL::to('vdmBusStops/' . $schoolId . ':' . $value) }}">Show stops</a><a class="btn btn-small btn-info" href="{{ URL::to('vdmBusRoutes/' . $key . '/edit') }}">Edit stops </a></td>
												</tr>
												@endforeach
										</table>
									</div>

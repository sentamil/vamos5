...
<div class="row">
   ...
   <div class="form-group">
    ...
    <div class="form-group">
        ...
        {{ Form::select('proximityLevel', array( '10' => '10 m','20' => '20 m','50' => '50 m', '100' => '100 m', '1000' => '1 km', '5000' => '5 km', '10000' => '10 km', '25000' => '25 km','50000' => '50 km','100000' => '100 km'), Input::old('proximityLevel'), array('class' => 'form-control')) }}             
    </div>
    <div class="form-group">

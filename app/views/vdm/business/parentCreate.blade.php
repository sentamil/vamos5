								...
								<table class="table table-bordered dataTable" style="z-index: -10px; position: relative">
									...
									<tbody>
										...
										<tr style="text-align: center;">
											...
											<td>{{ Form::select('deviceidtype' .$i, array( 'GT06N' => 'GT06N (9964)','GT300' => 'GT300 (9961)','TK103' => 'TK103 (9968)', 'TK99' => 'TK99 (9978)', 'FM1202' => 'FM1202 (9975)','FM1120' => 'FM1120 (9975)', 'TR02' => 'TR02 (9965)', 'GT03A' => 'GT03A (9969)', 'VTRACK2' => 'VTRACK2 (9964)','TRAKMATE' => 'TRAKMATE (9973)','GT02U' => 'GT02U (9990)','ET01'=>'ET01 (9971)','ET02'=>'ET02 (9962)', 'ET03'=>'ET03 (9974)','msi1001'=>'msi1001 (9964)','msi1002'=>'msi1002 (9968)'), Input::old('deviceidtype'), array('class' => 'form-control')) }}</td>
											...
											<td id="td{{$i}}" colspan="6">
												<table>
													...
													<tr style="height: 50px">
														...
														<td class="col-md-2">{{ Form::text('gpsSimNo'.$i, Input::old('gpsSimNo'), array('class' => 'form-control','placeholder'=>'Sim No')) }}</td>
													</tr>
													<tr style="height: 50px">	

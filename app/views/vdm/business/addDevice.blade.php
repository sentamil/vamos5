		...
		<div class="row">
    		<div class="col-lg-12">
					...
					<tbody>
							...
							<td>{{ Form::select('deviceidtype' .$i, array( 'GT06N' => 'GT06N', 'FM1202' => 'FM1202','FM1120' => 'FM1120', 'TR03' => 'TR03', 'GT03A' => 'GT03A', 'VTRACK2' => 'VTRACK2','EJECTA1'=>'EJECTA1','EJECTA2'=>'EJECTA2'), Input::old('deviceidtype'), array('class' => 'form-control')) }}</td>
																		</tr>
																	@endfor

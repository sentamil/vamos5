...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="pull-right">
               ...
               <a href="DeviceScan/sendExcel" ><img  class="pull-right"  width="20%" height="20%" src="../app/views/reports/image/xls.png" method="get"/ ></a>
            ...
            {{ Form::open(array('url' => 'DeviceScan','method' => 'post')) }}
                <div class="row" >
                    <div class="col-md-12">
                      <div  class="col-md-3" >
                        <div  class="row" >
                           {{ Form::text('text_word' , Input::old('text_word'),  array('class' => 'form-control', 'placeholder'=>'Search Devices'))}} 
                            <!--{{ Form::select('text_word' , array($devicesList), $text, array('class'=>'form-control selectpicker show-menu-arrow', 'data-live-search '=> 'true','placeholder'=>'Search Devices'))}} 
                            <div style="font-size: 9px; text-align: center;"><b>Note : </b> Use * for getting all Devices </div> -->
                        </div>
                      </div>
                      <div class="col-md-6">
			    ...
			    <!-- <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                	...
                	<div class="col-sm-12"> -->
				<div id="data" style="background-color: #f6eef0" class="form-group">
                ...
                @foreach($deviceMap as $key => $value)
                    ...
                    <td><a class="btn btn-sm btn-danger" href="{{ URL::to('vdmVehicles/move_vehicle/' . explode (',' ,$value )[0]) }}">Move Vehicle</a></td>                                     
                   </tr>
                 @endforeach
                 @endif

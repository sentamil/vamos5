...
//global declaration
 ...
 /*   var imgsName=[];
    imgsName=[{nam:"placeimg02"},{nam:"placeimg01"},{nam:"placeimg03"},{nam:"placeimg04"},{nam:"placeimg05"},{nam:"placeimg06"}];

    $scope.imgLocations=imgsName;*/
	...
	/*function getUiValue(){
	    ...
	    $scope.uiDate.fromdate 		=	$('#dateFrom').val();
      	...
      	$scope.uiDate.totime        =   $('#timeTo').val();
	  	  ...
	  	  console.log(	$scope.uiDate.fromtime	);
     	  	   console.log( $scope.uiDate.totime );
